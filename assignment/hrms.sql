...
-- Inserting records to regions table
...
-- Inserting records to countries table
...
-- Inserting records to locations
...
-- Inserting records to jobs table
...
-- Altering departments table (Adding foreign key)
...
-- Inserting records into job_history 
